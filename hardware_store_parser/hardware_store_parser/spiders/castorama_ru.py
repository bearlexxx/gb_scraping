...
class CastoramaRuSpider(scrapy.Spider):
    ...
    def goods_parse(self, response: HtmlResponse):
        ...
        loader.add_xpath('product_characteristics_keys',
                         "//div[contains(@class, 'product-block')]//dl[contains(@class, 'specs-table')]/dt/span[contains(@class, 'specs-table__attribute-name')]/text()")
        loader.add_xpath('product_characteristics_values',
                         "//div[contains(@class, 'specifications')]//dd[contains(@class, 'specs-table__attribute-value')]/text()")
